...
" call <sid>hi('iCursor',      s:cdBlue,       s:cdBlue,               'none',      {})
" call <sid>hi('CursorIM',     s:cdBlue,       s:cdBlue,               'none',      {})
call <sid>hi('Cursor',       {},             s:cdBrightBlack,        'none',      {})
...
call <sid>hi('FoldColumn',   s:cdLineNumber, s:cdNop,                'none',      {})
call <sid>hi('SignColumn',   {},             s:cdBrightBlack,        'none',      {})
call <sid>hi('IncSearch',    s:cdNone,       s:cdSelection,          'none',      {})
" call <sid>hi('LineNr',       s:cdLineNumber, s:cdNop,               'none',      {})
...
call <sid>hi('MoreMsg',      s:cdGray,       {},                     'none',      {})
...
call <sid>hi('WarningMsg',     s:cdOrange,     s:cdNop,                'none',      {})
...
call <sid>hi('Todo',           s:cdGreen,    s:cdNop,     'bold,italic', {})
...
call <sid>hi('pythonStrFormat',     s:cdYellowOrange, {}, 'none',   {})
...
" call <sid>hi('sh',                  s:,         {}, 'none', {})

" Todo:
call <sid>hi('TodoDone',      s:cdDarkGray,     {}, 'none', {})
call <sid>hi('TodoDate',      s:cdGray,         {}, 'none', {})
call <sid>hi('TodoProject',   s:cdBlueGreen,    {}, 'bold', {})
call <sid>hi('TodoContext',   s:cdYellowOrange, {}, 'bold', {})
call <sid>hi('TodoExtra',     s:cdYellow,       {}, 'bold', {})
call <sid>hi('TodoPriorityA', s:cdPink,         {}, 'none', {})
call <sid>hi('TodoPriorityB', s:cdBlue,         {}, 'none', {})
call <sid>hi('TodoPriorityC', s:cdGreen,        {}, 'none', {})
call <sid>hi('TodoPriorityD', s:cdYellow,       {}, 'none', {})
call <sid>hi('TodoPriorityE', s:cdYellow,       {}, 'none', {})
call <sid>hi('TodoPriorityF', s:cdYellow,       {}, 'none', {})
call <sid>hi('TodoComment',   s:cdGray,         {}, 'none', {})
...
call <sid>hi('vimIsCommand',      s:cdYellowOrange, {}, 'none', {})
...
call <sid>hi('vimHiLink',         {},               {}, 'none', {})
call <sid>hi('vimHLGroup',        {},               {}, 'none', {})
...
call <sid>hi('vimSynType',        s:cdBlue,         {}, 'none', {})
...
call <sid>hi('vimSynContains',    s:cdYellow,       {}, 'none', {})
...
call <sid>hi('termcursor',        s:cdViolet, s:cdBrightBlack, 'none', {})
call <sid>hi('termcursornc',      s:cdViolet, s:cdBrightBlack, 'none', {})
call <sid>hi('quickfixline',      s:cdViolet, s:cdBrightBlack, 'none', {})
...
" call <sid>hi('deniteSelectedLine',  {}, s:cdBlueGreen, 'none', {})
...
call <sid>hi('deniteModeNormal',    s:cdGreen,    {}, 'none', {})
call <sid>hi('deniteModeInsert',    s:cdBlue,     {}, 'none', {})
