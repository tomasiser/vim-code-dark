...
let s:p.insert.left     = [ [ s:cdFront, s:cdYellowOrange ], [ s:base3,  s:base01 ] ]
let s:p.insert.right    = [ [ s:cdFront, s:cdYellowOrange ], [ s:base3,  s:base01 ] ]
...
let s:p.visual.left     = [ [ s:cdFront, s:cdLightBlue ],    [ s:base3,  s:base01 ] ]
let s:p.visual.right    = [ [ s:cdFront, s:cdLightBlue ],    [ s:base3,  s:base01 ] ]
